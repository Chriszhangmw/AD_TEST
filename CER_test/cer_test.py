...
def get_test_by_kedaxunfei(path):
    cer_for_general_test = open('./cer_for_general_test.csv','w',encoding='utf-8')
    ...
    for dir in dirs:
        ...
        for file in child_files:
            if file.endswith('wav'):
                ...
                text_path = os.path.join(child_path,file_catalogs+'.txt')
                try:
                    ...
                    continue
                cer_for_general_test.write(str(text) + ','+refer + '\n')
    print('test number is :',number)



if __name__ == '__main__':
    path = '/home/zmw/big_space/zhangmeiwei_space/AD_TEST/cer_general_test/20-45h'
