...
def get_label_by_kedaxunfei(path):
    total_num = 0
    catalog_num = 0
    text_dic = {}
    ...
    for dir in dirs:
        ...
        for file in child_files:
            if file.endswith('wav'):
                file_name = file.replace('.wav','.txt')
                txt = open(os.path.join(child_path,file_name),'w',encoding='utf-8')
...
if __name__ == '__main__':
    # path = '/home/zmw/big_space/zhangmeiwei_space/AD_TEST/v_202110/方言测试语音包'
    path = '/home/zmw/big_space/zhangmeiwei_space/AD_TEST/temp_label/data'
    get_label_by_kedaxunfei(path)
